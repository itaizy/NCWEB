(function(root, factory) {
    ...
    "features": [{
        ...
        "geometry": {
            "type": "Polygon",
            "coordinates": ["@@F@DMFIJGQG@COEQM@@OASBBhB`R@DA@CD@DCFCHBLD"],
            "encodeOffsets": [
                [120023, 40073]
            ]
        },
        "properties": { "cp": [117.195907, 39.118327], "name": "市区", "childNum": 1 } // 和平区
    }, {
        "id": "120102",
        "geometry": {
            "type": "Polygon",
        ...
        "properties": { "cp": [117.226568, 39.122125], "name": "", "childNum": 1 } // 河东区
    }, {
        "id": "120103",
        "geometry": {
            "type": "Polygon",
            "coordinates": ["@@PSXSFQHEXKE@CMIFUQA@DC@CCA@CDE@CEE@FOc@@D{@ch]IIHAFE`AZTAPB@@RNPF@DPF"],
            "encodeOffsets": [
                [120036, 40057]
            ]
        },
        "properties": { "cp": [117.217536, 39.101897], "name": "", "childNum": 1 } // 河西区
    }, {
        "id": "120104",
        "geometry": {
            "type": "Polygon",
            "coordinates": ["@@@CAUC@@DCBQ@A_AqBOFaDEHEcKG@ED]ZY`ELEdkhHDRNCB@FD@BAFDDHD@JIDANFDECCZCBA\\B@Hd@JB"],
            "encodeOffsets": [
                [120008, 40087]
            ]
        },
        "properties": { "cp": [117.164143, 39.120474], "name": "", "childNum": 1 } // 南开区
    }, {
        "id": "120105",
        "geometry": {
            "type": "Polygon",
