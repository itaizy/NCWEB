...
class IhomeBaseprofileCopy(models.Model):
    userid = models.AutoField(primary_key=True)
    uid = models.IntegerField(blank=True, null=True)
    collegeid = models.CharField(max_length=30, blank=True, null=True)
    longid = models.CharField(max_length=30, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'ihome_baseprofile_copy'


class IhomeBaseprofileCopy1(models.Model):
    userid = models.AutoField(primary_key=True)
    uid = models.IntegerField(blank=True, null=True)
    collegeid = models.CharField(max_length=30, blank=True, null=True)
    longid = models.CharField(max_length=30, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'ihome_baseprofile_copy1'
...
class IhomeRecPublic(models.Model):
    id = models.IntegerField()
    uid = models.CharField(primary_key=True, max_length=45, blank=True, null=False)
    username = models.CharField(max_length=45, blank=True, null=True)
